...
describe("FlywayCliUrlBuilder", () => {
    ...
    it("can build a correct URL for different Flyway CLI versions", async () => {
        // V4.0.0
        const v400 = FlywayCliUrlBuilder.buildUrl(FlywayVersion["V4.0.0"], "macosx");
        ...
        // V5.0.0
        const v500 = FlywayCliUrlBuilder.buildUrl(FlywayVersion["V5.0.0"], "macosx");
        ...
        // V6.0.1
        const v601 = FlywayCliUrlBuilder.buildUrl(FlywayVersion["V6.0.1"], "windows");
        ...
        // V7.11.2
        const v7112 = FlywayCliUrlBuilder.buildUrl(FlywayVersion["V7.11.2"], "linux");
        ...
        // V8.5.6
        const v856 = FlywayCliUrlBuilder.buildUrl(FlywayVersion["V8.5.6"], "linux");
